<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand text-white" href="{{ route('home') }}">PGE Narodowy - wydarzenia 2024</a>
        ...
        <div class="collapse navbar-collapse no-print">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                @guest
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ route('login') }}">Zaloguj</a>
                    </li>
                    <li class="nav-item">
                ...
                @else
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ route('password.change.form') }}">Zmień hasło</a>
                    </li>
                    <li class="nav-item">
